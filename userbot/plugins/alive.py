...
LEGEND_IMG = "https://te.legra.ph/file/fef2d78da4110fbf98a2e.jpg"
CUSTOM_YOUR_GROUP = Config.YOUR_GROUP or "@PythonBot_Support"


@bot.on(admin_cmd(outgoing=True, pattern="dragon$"))
@bot.on(sudo_cmd(pattern="dragon$", allow_sudo=True))
async def amireallyalive(alive):
    ...
    if LEGEND_IMG:
        LEGEND_caption = f"**DragonRoBot is Up And Running**\n\n"
        LEGEND_caption += f"      🔰RoBot Status🔰 \n"
        LEGEND_caption += f"{alive_emoji} **DragonRoBo† version**   ~ {LEGENDversion}\n"
        LEGEND_caption += (
...
msg = (
    ...
    or f"""
**  ⚜️ DragonRoẞø† is Online ⚜️**
     {Config.ALIVE_MSG}
    ** Bot Status **
**🔰 Owner   :** **{Config.ALIVE_NAME}**
**✨ DargonRoBot  :** {LEGENDversion}
...
file1 = "https://te.legra.ph/file/fef2d78da4110fbf98a2e.jpg"
file2 = "https://te.legra.ph/file/c09065bcec846867920eb.jpg"
file3 = "https://te.legra.ph/file/26aa060c22fa187fc4255.jpg"
file4 = "https://te.legra.ph/file/131e68172389ed4107d5c.jpg"
file5 = "https://te.legra.ph/file/a65b33005eb5b79bbecb6.jpg"
"""=======================CONSTANTS====================== """
pm_caption = f"**╭────────────**\n"
pm_caption += f"┣✨ Owner   ~ {Config.ALIVE_NAME}\n"
pm_caption += f"┣✨ DragonRoẞø† ~ {LEGENDversion}\n"
pm_caption += f"┣✨ LegendPro   ~ [Owner](https://t.me/Dark_Legend_Pro)\n"
pm_caption += f"┣✨ Support ~ [Group](https://t.me/PythonBot_Support)\n"
pm_caption += f"┣✨ Repo   ~ [Repo](https://github.com/DARK-LEGEND-PRO/PRO-DRAGONSETUP)\n"
pm_caption += f"**╰────────────**\n"
...
CmdHelp("alive").add_command("bot", None, "υѕє αи∂ ѕєє").add_command(
    "dragon", None, "Its Same Like Alive"
